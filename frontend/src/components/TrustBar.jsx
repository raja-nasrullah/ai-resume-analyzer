export default function TrustBar() {
  return (
    <section className="border-t border-gray-200/60 py-6">
      <div className="max-w-7xl mx-auto px-8 flex flex-wrap items-center justify-center gap-4">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 md:gap-8 opacity-60">
          ...
          <div className="flex items-center gap-1.5 text-gray-600">
            ...
            <span className="text-xs font-medium tracking-tight">Apple</span>
          </div>
          ...
          <div className="flex items-center gap-1.5 text-gray-600">
            ...
            <span className="text-xs font-medium tracking-tight">Microsoft</span>
          </div>
          ...
          <div className="flex items-center gap-1.5 text-gray-600">
            ...
            <span className="text-xs font-medium tracking-tight">Corporate</span>
          </div>
        </div>
      </div>
    </section>
